...
from boxmot.trackers.deepsort.sort import iou_matching, linear_assignment
from boxmot.trackers.deepsort.sort.track import Track
...
class Tracker:
    ...
    max_iou_dist : float
        Maximum IoU distance accepted during the IoU association step.
    max_age : int
    ...
    def update(self, detections):
        ...
        # Update distance metric. The accumulated per-track feature galleries are
        # handed to the metric (which enforces the budget) and then cleared.
